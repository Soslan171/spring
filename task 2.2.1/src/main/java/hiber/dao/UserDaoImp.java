...
import exepcion.CarNotFoundException;
...
public class UserDaoImp implements UserDao {
   ...
   public User findOwner(String car_name, String car_series) {
      Query findCarQuery = sessionFactory.getCurrentSession().createQuery("from Car where name = :car_name and series = :car_series")
